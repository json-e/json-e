(function (global, factory) {
	...
	function requireAST () {
		...
		AST.ContextValue = ContextValue;
		AST.ValueAccess = ValueAccess;
		AST.List = List;
		AST.Object = Object;
		return AST;
	}
	...
	function requireError () {
		...
		error = {JSONTemplateError, SyntaxError, InterpreterError, TemplateError, BuiltinError};
		return error;
	}
	...
	var fromNow;
	var hasRequiredFromNow;

	function requireFromNow () {
		if (hasRequiredFromNow) return fromNow;
		hasRequiredFromNow = 1;
	...
	var jsonStableStringifyWithoutJsonify;
	var hasRequiredJsonStableStringifyWithoutJsonify;

	function requireJsonStableStringifyWithoutJsonify () {
		if (hasRequiredJsonStableStringifyWithoutJsonify) return jsonStableStringifyWithoutJsonify;
		hasRequiredJsonStableStringifyWithoutJsonify = 1;
		jsonStableStringifyWithoutJsonify = function (obj, opts) {
		    if (!opts) opts = {};
		...
		return jsonStableStringifyWithoutJsonify;
	}
	...
	function requireBuiltins () {
		...
		var {BuiltinError} = requireError();
		var fromNow = requireFromNow();
		var {
	...
	function requireSrc () {
		...
		const {Interpreter} = requireInterpreter();
		var fromNow = requireFromNow();
		var stringify = requireJsonStableStringifyWithoutJsonify();
		var {
		  isString, isNumber, isBool,
		  isArray, isObject,
		  isTruthy, isFunction,
